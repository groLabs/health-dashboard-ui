...
export const showHeaders = () => (
    < React.Fragment >
        ...
        <TableCell align="right" style={{fontWeight:'bold', color: '#651C9C'}}>Δ Curve Cache</TableCell>
        ...
        <TableCell align="right" style={{fontWeight:'bold', color: '#651C9C'}}>Δ Chainlink</TableCell>
